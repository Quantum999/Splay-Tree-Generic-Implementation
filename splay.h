...
class iterator_traits{
    public:
        int iterator_category(){
            if(typename iterator_traits<ptr_t>::iterator_category() == input_iterator_tag)  return 1;
            else if(typename iterator_traits<ptr_t>::iterator_category() == output_iterator_tag)  return 2;
            else if(typename iterator_traits<ptr_t>::iterator_category() == forward_iterator_tag)  return 3;
            else if(typename iterator_traits<ptr_t>::iterator_category() == bidirectional_iterator_tag)  return 4;
            else if(typename iterator_traits<ptr_t>::iterator_category() == random_access_iterator_tag)  return 5;
            else return 6;
        }
    private:
